...
# Sets up Oh My Posh, fzf, and ps-fzf for PowerShell 7
...
# Welcome message
Write-Host "🚀 PowerShell environment loaded with Oh My Posh and fzf!" -ForegroundColor Green
"@
...
try {
    ...
    Write-Host "   2. Enjoy your new Oh My Posh prompt and fzf functionality!" -ForegroundColor White
    Write-Host ""
